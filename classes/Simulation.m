 classdef Simulation < handle
    ...
    methods
        ...
        function Make_Figure_Coordinate_Frames(self)
            self.baseFrame.Generate_Coordinate_Frame_Graph();
        end
...
%                 end
        ...
        function fig_handle = Make_Hydropathy_Sidechain_Scatter_Plot_Helix(self, data)
            fig_handle = figure();
            hold on
...
%                 calculated_force = ( constant * ( charge_one*charge_unit  * charge_two*charge_unit ) ./ ( distance*distance_unit )' .^ 2);
        ...
        function [forceSum, forces, combinations] = Run_Bundle_Static_Force(self, bundle_pdb_path, bundle_helix_indeces)
        ...
        % Unbounded Optimsation Work and Simulations
    ...
    methods (Static)
        function pdb_filepaths = Load_PDB_Filepaths()
            pdb_filepaths = [ ...
                "../../Data/talin_pdb_files/SWISS/R1.pdb",...
                "../../Data/talin_pdb_files/SWISS/R2.pdb",...
                "../../Data/talin_pdb_files/SWISS/R3.pdb",...
                "../../Data/talin_pdb_files/SWISS/R4.pdb",...
                "../../Data/talin_pdb_files/SWISS/R5.pdb",...
                "../../Data/talin_pdb_files/SWISS/R6.pdb",...
                "../../Data/talin_pdb_files/SWISS/R7R8.pdb",...
                "../../Data/talin_pdb_files/SWISS/R7R8.pdb",...
                "../../Data/talin_pdb_files/SWISS/R9.pdb",...
                "../../Data/talin_pdb_files/SWISS/R10.pdb",...
                "../../Data/talin_pdb_files/SWISS/R11.pdb",...
                "../../Data/talin_pdb_files/SWISS/R12.pdb",...
                "../../Data/talin_pdb_files/SWISS/R13.pdb",...
                ];
        end
        ...
        function forces = Run_All_Bundle_Static_Forces()
            ...
            for i = 1:13
               sim = Simulation();
               [sum, ~, ~] = sim.Run_Bundle_Static_Force(pdb_filepaths(i), helix_indeces(i,:,:));
               forces(i) = sum;
            end
        end
    end
